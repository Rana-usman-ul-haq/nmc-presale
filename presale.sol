...
contract NMCPresale is Ownable {
    ...
    address public wallet = payable(0x0Bd590b57BC6e78536d1Dd59878dF20ABD524B58);

    // How many token units a buyer gets per BNB & USDT
    uint256 private bnbRate = 500000000000;
    uint256 private usdtRate = 2222222222;
    ...
    function buyTokens() public payable {
        ...
        require(msg.value >= 0.02 ether, "cant buy less with than 0.005 ETH");
        require(9.5 ether >= msg.value, "cannot buy with more than 10 ETH");
    ...
    function buyTokensWithUSDT(uint256 amount) public {
        require(hasPresaleStarted,"Presale not started");
        require(!hasPresaleEnded, "Presale has ended");
        require(amount >= 5 * 10 ** 18, "cant buy less with than 5 USDT");
        require(2200 * 10 ** 18 >= amount, "cannot buy with more than 2200 USDT");
